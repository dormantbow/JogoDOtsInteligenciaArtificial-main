...
public class dotsEuristico {
	...
	int segundaJogada;
	int vez=0;
	arvoreEuristica arvo;
	Scanner entradaProf;	
	int profundidade;
	int nDeJogadas=0;
	public void jogo() {	
		/*
		 * pedimos a dificuldade da IA
		 */
		System.out.println("Qual a profundidade desejada?(dificulade)");
		...
		arvo = new arvoreEuristica(primeiraJogada,segundaJogada);
	...
	/*rebendo entrada usuario
	 * se for diferente de 46 significa q é uma jogada pré definida, se nao pede ao usuario
	 * verifica se entrada é valida e adiciona ao tabuleiro
	 */
	...
	/*Verificamos se tem quadrado formado apartir  das jogadas realizadas
	 * atualiza matriz do tabuleiro com quadrados formados
	 */
